...
file_tups_traj = [['../reference/traj-cychex-neat/cyclohexane_250_'+i+'_wNoConstraints_1fsts_short.nc'] for i in file_strings]
file_tups_traj_vac = [['../reference/traj-cychex-neat/cyclohexane_'+i+'_wNoConstraints_vacuum_0.8fsts.nc'] for i in file_strings]

file_tups_sd = [['../reference/StateData-cychex-neat/cyclohexane_250_'+i+'_wNoConstraints_1fsts_short.csv'] for i in file_strings]
file_tups_sd_vac = [['../reference/StateData-cychex-neat/cyclohexane_'+i+'_wNoConstraints_vacuum_0.8fsts.csv'] for i in file_strings]
...
df.to_csv('../MBAR-estimates/MBAR_estimates_[6X4:1]_eps'+argv[1]+'-'+argv[2]+'_rmin'+argv[3]+'-'+argv[4]+'_test.csv',sep=';')
